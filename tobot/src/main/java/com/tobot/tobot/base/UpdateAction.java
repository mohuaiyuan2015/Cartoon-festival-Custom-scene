...
public class UpdateAction {
    ...
    private static SaveListener mSaveListener;
...
//                        ActionEntity danceList = new Gson().fromJson(response, ActionEntity.class);
                        mSaveListener.setSaveResource(response);
                    }
                });
    }

    public static void setSaveListener(SaveListener saveListener) {
        mSaveListener = saveListener;
    }

    public interface SaveListener{
        void setSaveResource(String demand);
    };
